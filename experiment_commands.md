...
uv run expressive/experiments/mnist_op/mnistop.py --allowed_digits 1 2 3 --stratified True
```

MNIST Add N=15:
```
uv run expressive/experiments/mnist_op/mnistop.py --N 15 --epochs 1000
uv run expressive/experiments/mnist_op/mnistop.py --N 15 --epochs 1000 --allowed_digits 1 2 3 --stratified True
```
